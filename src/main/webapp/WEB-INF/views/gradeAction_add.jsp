            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="actionName" class="form-control" id="userName_add_input" placeholder="roleName">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="actionVal" class="form-control" id="passwd_add_input" placeholder="passwd">
                        </div>
                    </div>
