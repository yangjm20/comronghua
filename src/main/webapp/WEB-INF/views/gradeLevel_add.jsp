    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" id="name_add_input" placeholder="roleName">
                            <span class="help-block"></span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label">积分上限值</label>
                        <div class="col-sm-10">
                            <input type="text" name="maxScore" class="form-control" id="maxScore_add_input" placeholder="passwd">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="save_gradeLevel_btn" class="btn btn-primary">保存</button>
            </div>
