    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" id="userName_add_input" placeholder="roleName">
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="add_funcs">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="save_roles_btn" class="btn btn-primary">保存</button>
            </div>
